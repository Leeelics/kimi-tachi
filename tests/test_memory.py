...
try:
    from kimi_tachi.memory import TachiMemory, get_memory, AGENT_PROFILES
    from kimi_tachi.memory.agent_profiles import MemoryProfile, AGENT_MEMORY_PROFILES
...
class TestAgentProfiles:
    ...
    def test_agent_profiles_exist(self):
        ...
        expected_agents = [
            "kamaji", "shishigami", "nekobasu", 
            "calcifer", "enma", "tasogare", "phoenix"
        ]
